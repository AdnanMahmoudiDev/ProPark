<x-app-layout>
    <div class="py-12 px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto">
        ...
        <div class="space-y-6">
            ...
            <div class="bg-gray-900/80 backdrop-blur-sm border border-gray-800/80 rounded-2xl p-6 sm:p-8 hover:border-blue-500/30 transition-colors" data-reveal>
                <div class="flex items-center gap-3 mb-4">
                    ...
                    <h2 class="text-lg sm:text-xl font-bold text-white">{{ __('terms_sec1_title') }}</h2>
                </div>
            ...
            <div class="bg-gray-900/80 backdrop-blur-sm border border-gray-800/80 rounded-2xl p-6 sm:p-8 hover:border-blue-500/30 transition-colors" data-reveal>
                <div class="flex items-center gap-3 mb-4">
                    ...
                    <h2 class="text-lg sm:text-xl font-bold text-white">{{ __('terms_sec2_title') }}</h2>
                </div>
                <ul class="text-sm text-gray-300 space-y-3 leading-relaxed">
                    <li class="flex items-start gap-2">
                        <span class="text-blue-400 mt-1">•</span>
                        <span>{{ __('terms_sec2_item1') }}</span>
                    </li>
                    <li class="flex items-start gap-2">
                        <span class="text-blue-400 mt-1">•</span>
                        <span>{{ __('terms_sec2_item2') }}</span>
                    </li>
                    <li class="flex items-start gap-2">
                        <span class="text-blue-400 mt-1">•</span>
                        <span>{{ __('terms_sec2_item3') }}</span>
                    </li>
                </ul>
            </div>
            ...
            <div class="bg-gray-900/80 backdrop-blur-sm border border-gray-800/80 rounded-2xl p-6 sm:p-8 hover:border-blue-500/30 transition-colors" data-reveal>
                <div class="flex items-center gap-3 mb-4">
                    ...
                    <h2 class="text-lg sm:text-xl font-bold text-white">{{ __('terms_sec3_title') }}</h2>
                </div>
            ...
            <div class="bg-gray-900/80 backdrop-blur-sm border border-gray-800/80 rounded-2xl p-6 sm:p-8 hover:border-blue-500/30 transition-colors" data-reveal>
                <div class="flex items-center gap-3 mb-4">
                    ...
                    <h2 class="text-lg sm:text-xl font-bold text-white">{{ __('terms_sec4_title') }}</h2>
                </div>
                <p class="text-sm text-gray-300 leading-relaxed text-justify">
                    {{ __('terms_sec4_desc') }}
                </p>
        ...
        <div class="mt-10 text-center" data-reveal>
            <a href="{{ url()->previous() ?: route('login') }}" class="inline-flex items-center gap-2 px-6 py-2.5 rounded-xl bg-gray-800 hover:bg-gray-700 text-gray-200 text-sm font-medium border border-gray-700 transition group">
                <svg class="w-4 h-4 rtl:rotate-0 ltr:rotate-180 transition-transform duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 5l7 7m0 0l-7 7m7-7H3"/></svg>
