...
<html lang="fa" dir="rtl" class="dark">
    <head>
        ...
        {{-- صفحات احراز هویت به صورت پیش‌فرض برای بهینه‌سازی بودجه خزش نباید ایندکس شوند --}}
        ...
        <style>
            ...
            /* موبایل: لود مستقیم بدون ترنزیشن برای حداکثر سرعت و پاسخ‌دهی کیبورد */
    ...
    <body class="font-sans text-gray-100 antialiased bg-gradient-to-br from-blue-950 via-gray-950 to-gray-950 min-h-screen relative overflow-x-hidden selection:bg-blue-600 selection:text-white">
        ...
        <div class="fixed inset-0 pointer-events-none z-0 overflow-hidden transform-gpu" aria-hidden="true">
            ...
            {{-- هاله‌های بلور سنگین منحصراً در دسکتاپ رندر می‌شوند --}}
            <div class="hidden md:block absolute top-0 left-1/2 -translate-x-1/2 w-[1000px] h-[400px] bg-blue-600/20 rounded-full blur-[140px]"></div>
            <div class="hidden md:block absolute bottom-1/4 -left-40 w-[350px] h-[350px] bg-sky-600/15 rounded-full blur-[120px]"></div>
        </div>

        <!-- بدنه اصلی فرم‌های ورود و ثبت‌نام -->
