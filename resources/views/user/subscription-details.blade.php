        ...
        <div class="flex items-center justify-between gap-4">
            ...
            >
                <svg
                    ...
                    class="h-4 w-4 transition duration-300 group-hover:translate-x-1 rtl:rotate-180"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                >
        ...
        <div class="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
            <div class="overflow-hidden rounded-3xl bg-[#0f1420] shadow-lg ring-1 ring-white/5">
                    ...
                    <div class="flex flex-col gap-5 md:flex-row md:items-center md:justify-between">
                        ...
                        <div>
                            <span class="inline-flex items-center gap-2 rounded-full px-4 py-2 text-xs font-bold tracking-wider
                                ...
                                {{ $isActive ? __('sub_active') : __('sub_inactive') }}
                            </span>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="grid grid-cols-1 gap-6 lg:grid-cols-2">
                        ...
                        <div class="space-y-6">
                            <div class="rounded-2xl bg-[#111827] p-5 ring-1 ring-white/5 sm:p-6">
                                ...
                                <div class="mb-5">
                                    <span class="mb-2 block text-xs text-gray-500">{{ __('sub_license_code') }}</span>
                                ...
                                <div class="space-y-4">
                                    <div class="flex items-center justify-between gap-4 border-t border-white/5 pt-4">
                                        <span class="text-sm text-gray-400">{{ __('sub_devices_connected') }}</span>
                                        <span class="text-sm font-semibold text-white">{{ $connectedDevicesCount }} {{ __('sub_devices') }}</span>
                                    </div>
                                    <div class="flex items-center justify-between gap-4 border-t border-white/5 pt-4">
                                        <span class="text-sm text-gray-400">{{ __('sub_max_devices') }}</span>
                                        <span class="text-sm font-semibold text-white">{{ ($maxAllowedDevices ?? 'N/A') }} {{ __('sub_devices') }}</span>
                                    </div>
                                </div>
                                ...
                                <div class="mt-5">
                                    ...
                                    >
                                        ...
                                        <span>{{ __('sub_manage_devices') }}</span>
                                    </a>
                                </div>
                                ...
                                <div class="mt-5 border-t border-white/5 pt-4">
                                    <div class="flex items-start gap-3 rounded-xl bg-blue-500/5 p-4 ring-1 ring-blue-400/10">
                                        ...
                                        <div>
                                            <p class="text-xs font-bold text-gray-200">{{ __('sub_connection_title') }}</p>
                                            <p class="mt-1 text-[11px] leading-5 text-gray-400">
                                                {{ __('sub_connection_desc', ['count' => $connectedDevicesCount, 'max' => $maxAllowedDevices]) }}
                                            </p>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="flex flex-wrap gap-3 bg-[#0c111b] px-5 py-5 sm:px-8">
                    ...
                    >
                        ...
                        <span>{{ __('sub_print_receipt') }}</span>
                    </button>
                </div>
            </div>
            ...
            <div class="mt-6 text-center">
                <p class="text-sm text-gray-500">
                    {!! __('sub_support_help') !!}
                    <a href="#" class="text-blue-400 transition-colors hover:text-blue-300 hover:underline">{{ __('sub_support_link') }}</a>
                </p>
            </div>
        </div>
    </div>
